    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/events/{id}/cancel").hasRole("ADMIN")
                        .requestMatchers("/api/auth/promote/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/registrations/{eventId}").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.DELETE, "/api/registrations/{eventId}").hasRole("STUDENT")
                        .requestMatchers("/api/registrations/my").hasRole("STUDENT")
                        .requestMatchers("/api/registrations/event/**").hasRole("ADMIN")
                        .requestMatchers("/api/registrations/{id}/attend").hasRole("ADMIN")
